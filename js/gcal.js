...
$(document).ready(function() {
    ...
    if ($('#calendar_parent').length > 0) {
        ...
        // var time_min = (new Date()).toISOString();
        var now = Date.now();
        // https://www.googleapis.com/calendar/v3/calendars/veg2nl14tb7grfpkhaevp3f8rk%40group.calendar.google.com/events?key=
        var events = $.ajax({
    ...
    //   var CLIENT_ID = 'veg2nl14tb7grfpkhaevp3f8rk%40group.calendar.google.com';
    //   var API_KEY = 'AIzaSyDAmmTH7oX8pRBMCyDXVfKWI5m7U8myTnE';
    //
